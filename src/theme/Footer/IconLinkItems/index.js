...
export default function IconLinkItems() {
    ...
    return (
        <div className="communityLinksContainer">
            ...
            <IconLinkItem IconComponent={TGIcon} onIconClick={GoToCommunityLink('https://t.me/alloc-init')}></IconLinkItem>
            <IconLinkItem IconComponent={GHIcon} onIconClick={GoToCommunityLink('https://github.com/alloc-init')}></IconLinkItem>
        </div>
    );
}
